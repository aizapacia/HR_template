              ...
              <div class="modal-body">
                <form>
                  <div class="form-group">
                    ...
                    <vue-select :options="addmodalovertime" />
                  </div>
                  <div class="form-group">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form>
                  <div class="form-group">
                    <label>Select Employee <span class="text-danger">*</span></label>
                    <vue-select :options="editmodalovertime" />
                  </div>
                  <div class="form-group">
                    <label>Overtime Date <span class="text-danger">*</span></label>
                    <div class="cal-icon">
...
<script>
  ...
  export default {
     data() {
    return {
      addmodalovertime: ["-", "John Doe", "Richard Miles", "John Smith"],
      editmodalovertime: ["-", "John Doe", "Richard Miles", "John Smith"],
