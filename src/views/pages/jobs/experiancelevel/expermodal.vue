                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <vue-select :options="addexperiencestatus" />
                      </div>
                    </div>
                ...
                <form>
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label class="col-form-label">Status</label>
                        <vue-select :options="editexperiencestatus" />
                      </div>
                    </div>
...
<script>
  ...
  export default {
    data() {
    return {
      addexperiencestatus: ["Select", "Active", "Inactive"],
      editexperiencestatus: ["Select", "Active", "Inactive"]
    }
    },
    components: {
